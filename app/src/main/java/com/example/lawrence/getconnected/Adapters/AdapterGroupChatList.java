...
import com.example.lawrence.getconnected.GroupChatActivity;
...
public class AdapterGroupChatList extends RecyclerView.Adapter<AdapterGroupChatList.HolderGroupChatList> {
    ...
    private void loadLastMessage(ModelGroupChatlist model, HolderGroupChatList holder) {
        ...
        ref.child(model.getGroupId()).child("messages").limitToLast(1)//get last item(messag)
                ...
                for (DataSnapshot ds: dataSnapshot.getChildren()) {
                 String message= ""+ds.child("message").getValue();
                    ...
                    else
                    {
                     ...
                     //get info of the last sender of message
    ...
    class HolderGroupChatList extends RecyclerView.ViewHolder {
        private ImageView groupIconIv,messageIv;
        private TextView groupTitleTv,usernameTv,messageTv,timeTv;
