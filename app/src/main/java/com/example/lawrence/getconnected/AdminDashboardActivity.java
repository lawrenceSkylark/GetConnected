...
import com.example.lawrence.getconnected.Adapters.ICallBackFromDbAdapter;
import com.example.lawrence.getconnected.Adapters.User_Adapter;
import com.example.lawrence.getconnected.models.Booking;
import com.example.lawrence.getconnected.models.User;
import com.example.lawrence.getconnected.dataaccess.DbAdapter;
import com.example.lawrence.getconnected.dataaccess.FBDB;
...
public class AdminDashboardActivity extends BaseActivity implements ICallBackFromDbAdapter {
    ...
    public void onSearchClick(View v)
    {
        ...
        new FBDB(this).searchUserByName(stUserName);
    ...
    {
        lvUserList = ((Activity) ctx).findViewById(R.id.lvUserList);
        User_Adapter adapter = new User_Adapter((Activity) ctx, R.layout.eachuser, allUserList);
        lvUserList.setAdapter(adapter);
        //listAllAppV ref fetched in onCreate becomes NULL in this callBk!!! So get a fresh ref!
    }
    ...
    public void onResponseFromServer(String result, Context ctx)//OLD Azure implementation
    {
        ...
        try {
            ...
            User_Adapter adapter = new User_Adapter((Activity) ctx, R.layout.eachuser, (ArrayList<User>) allUserList);
