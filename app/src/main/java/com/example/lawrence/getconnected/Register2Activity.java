...
import com.example.lawrence.getconnected.helpers.AESCrypt;
...
public class Register2Activity extends BaseActivity {
    ...
    String ROLE_CODE = "0",
            roleStr, txtVeriCode,formData, uName, uPass,fName, lName, add, city, postC, key_uName, key_uPass;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        btnCreateNewUser.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                boolean success = new FBDB(Register2Activity.this).registerUser(newUser);
